...
- 設定画面を開いたとき
- 履歴画面を開いたとき
- ローカルでは発話が止まっており、最後の transcription activity から 10 秒経過したとき
...
ローカル発話検知中は 10 秒タイマーを進めず、該当する transcription activity が来たあとに再び 10 秒カウントを開始する。
...
2. 話し続けている間は 10 秒タイムアウトで premature finish しない。
